...
const Admin = () => {
  ...
  const menuItems = [
    { key: "registration", icon: "✦", label: "New Account",  group: "Clients"    },
    { key: "clients",      icon: "◈", label: "All Clients",  group: "Clients"    },
    { key: "accounts",     icon: "◉", label: "Accounts",     group: "Operations" },
    { key: "transactions", icon: "⇄", label: "Transactions", group: "Operations" },
    { key: "loans",        icon: "◐", label: "Loans",        group: "Operations" },
    { key: "reports",      icon: "▦", label: "Reports",      group: "Analytics"  },
  ...
  return (
    <div style={{ display: "flex", minHeight: "100vh", fontFamily: "'Georgia', 'Times New Roman', serif", background: "#f5f3ef" }}>
      ...
      {/* ── Sidebar ── */}
      <div style={{
        width: collapsed ? 64 : 240, transition: "width 0.3s cubic-bezier(0.4,0,0.2,1)",
      ...
      <div style={{ flex: 1, display: "flex", flexDirection: "column", overflow: "hidden" }}>
        ...
        <header style={{
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
            <span style={{ color: "#999", fontSize: 12 }}>Admin</span>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 16 }}>
            <div style={{ textAlign: "right" }}>
              ...
              <div style={{ fontSize: 10, color: "#999", letterSpacing: 0.5 }}>
                {user?.role === "admin" ? "Admin" : "Staff"} · Tunis
              </div>
            </div>
            <div style={{ width: 36, height: 36, borderRadius: "50%", background: "linear-gradient(135deg, #0a1628, #1a3a6b)", display: "flex", alignItems: "center", justifyContent: "center", color: "#e8d48b", fontSize: 13, fontWeight: 700 }}>
              {initials}
            </div>
            <button onClick={handleLogout} style={{
              background: "none", border: "1px solid #e8e2d8", borderRadius: 8,
              color: "#aaa", fontSize: 11, padding: "6px 12px", cursor: "pointer", letterSpacing: 0.5,
            }}>
              Sign out
            </button>
          </div>
        ...
        <main style={{ flex: 1, overflow: "auto", padding: "32px" }}>
          ...
          {activeMenu === "registration" && <RegisterForm />}
