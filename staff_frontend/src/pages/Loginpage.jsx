...
export default function LoginPage() {
  ...
  const handleConfirm = async () => {
    ...
    if (!user) return; // login failed, error shown by context
...
const styles = {
  page: {
    ...
    fontFamily: "Helvetica", overflow: "hidden",
  },
  bgImage: {
  ...
  card: {
    ...
    border: "1px solid rgba(108,108,108,0.50)", borderRadius: 18,
    boxShadow: `
  ...
  title: { color: "#fff", fontSize: 36, fontWeight: 700, textAlign: "center", marginBottom: 20 },
  divider: { height: 1, background: "rgba(255,255,255,0.2)", marginBottom: 32 },
  fields: { display: "flex", flexDirection: "column", gap: 20, marginBottom: 32 },
  error: { color: "#f87171", fontSize: 13, textAlign: "center", marginBottom: 12 },
  btn: {
    width: "100%", padding: "15px", background: "#1C398E", color: "#FFFFFF",
    border: "none", borderRadius: 8, fontSize: 17, fontWeight: 600,
